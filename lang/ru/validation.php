...
return [
    ...
    | например, правила размера. Вы можете изменить эти сообщения по своему усмотрению.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Указанное значение :attribute было найдено в утечке данных. Пожалуйста, выберите другое значение для :attribute.',
    ],
    ...
    /*
    |--------------------------------------------------------------------------
    | Пользовательские сообщения для валидации
    |--------------------------------------------------------------------------
    |
    | Здесь вы можете указать пользовательские сообщения для атрибутов, используя
    | соглашение "attribute.rule". Это позволяет быстро указать пользовательское
    | сообщение для конкретного правила атрибута.
    |
    */
    ...
    | на более понятное для пользователя значение, например, "Адрес электронной почты"
    | вместо "email". Это помогает сделать сообщения более выразительными.
    |
    */
